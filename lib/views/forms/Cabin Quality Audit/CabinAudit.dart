...
class AuditCheckItems {
  // Seat check items (First Class, Comfort, Main Cabin)
  static const List<String> seatItems = [
    'Seatbelt',
    'Tray Table',
    'IFE Screen',
    'Seat Back Trash',
  ...
  // Lav (bathroom) check items
  static const List<String> lavItems = [
    'Cleanliness',
    'Toilet / Seat',
    'Sink & Faucet',
    'Mirror',
    'Trash Receptacle',
    'Soap / Supplies Stocked',
    'No Odor',
  ];

  // Galley (kitchen) check items
  static const List<String> galleyItems = [
    'Counter Cleanliness',
    'Trash Receptacle',
    'Compartment / Drawers',
    'Equipment Condition',
...
class CabinAudit extends GetxController {
  ...
  List<String> getCheckItemsForSeat(String seatId) {
    ...
    if (section == 'lav') return AuditCheckItems.lavItems;
    if (section == 'galley') return AuditCheckItems.galleyItems;
    return AuditCheckItems.seatItems;
  }
